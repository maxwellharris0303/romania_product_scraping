...
# Connection details
host = '185.199.175.184'
user = 'houseall_zilanonline'
password = '1q2w3e$R.!'
database = 'houseall_zilanonline'
...
INSERT INTO {TABLE_NAME} (
        product_code, name, short_description, description, stock, weight, length, width, height, sale_price, regular_price, categories, images, product_url,
